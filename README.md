...
I'm currently in my **first year** in engieneer school. <!--My goal is to become an **engieneer** specialized in **computer science**. -->
...
- **CESI engineering school, Nanterre**
  - Currently in my **1st year** of higher education in **software engieneer**.
...
- **Concept of newtwork learned :** DNS, VLAN, DHCP, etherchannel, OSPF, HTTPS
- **Tools used :** Git, GitHub, GitLab, Postman, Lucidchart (UML), VMware, Packet Tracer, MySQL, MariaDB, Windows, Linux, Excel, Word, Docker, MySQL
